...
export default function SloganForm({ setSlogans, slogans }) {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    // This component takes in a prop called setSlogans, 
    // which is a function that takes in an array of slogans. 
    // Also, this component also takes in a prop called slogans, 
    //which is an array of strings. 
    //// On submit call the setSlogans state with a new array 
    //that is a copy of the old array with the new slogan immutably added to the end 
  ...
  return (
    <section>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* also, weirdly, set the value of this input to the sloganInput 
        tracked in state to make this a 'controlled' form input */}
